...
class DelegationMixin:
    ...
    def configure_delegation(
        ...
        *,
        ...
        """
        from agenticflow.reactive.a2a_tools import create_delegate_tool, create_reply_tool
        ...
        if can_delegate:
            ...
            if can_delegate is True:
                ...
                if trigger_config and hasattr(self, '_agents_registry'):
                    registry = getattr(self, '_agents_registry')
                    specialists = [
    ...
    def _resolve_specialists(
        ...
        # Topologies: look for workers or other agents
            ...
            agents_list = getattr(self, '_agents')
