...
This module re-exports embeddings from cogent.models for backward compatibility.
Prefer importing directly from cogent.models for new code:

    from cogent.models import create_embedding, MockEmbedding
...
from cogent.models.mock import MockEmbedding
from cogent.models.ollama import OllamaEmbedding as OllamaEmbeddings
from cogent.models.openai import OpenAIEmbedding as OpenAIEmbeddings
