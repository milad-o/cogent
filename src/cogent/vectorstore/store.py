...
from cogent.vectorstore.backends.inmemory import InMemoryBackend, SimilarityMetric
from cogent.vectorstore.base import (
    EmbeddingProvider,
    SearchResult,
    VectorStoreBackend,
)
from cogent.vectorstore.document import Document, create_documents
from cogent.vectorstore.embeddings import MockEmbeddings
...
async def _emit_event(event_type: str, data: dict[str, object]) -> None:
    ...
    try:
        from cogent.observability.bus import get_event_bus
...
class VectorStore:
    ...
    Example:
        ...
        >>> from cogent.vectorstore import OllamaEmbeddings
