...
from cogent.retriever.utils.fusion import fuse_results, normalize_scores
...
class EnsembleRetriever(BaseRetriever):
    ...
    Example:
        >>> from cogent.retriever import EnsembleRetriever, DenseRetriever, BM25Retriever
    ...
    async def add_documents(self, documents: list[Document]) -> None:
        ...
        for retriever in self._retrievers:
            if hasattr(retriever, "add_documents"):
                add_fn = retriever.add_documents
