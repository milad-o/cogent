...
from cogent.retriever.base import BaseRetriever, FusionStrategy, RetrievalResult
from cogent.retriever.utils import fuse_results
    ...
    def get_representation_stats(self) -> dict[str, object]:
        ...
        for rep_type in self._representations:
            ...
            for doc_reps in self._doc_representations.values():
                ...
                elif rep_type == "entities" and doc_reps.entities:
                    count += 1
