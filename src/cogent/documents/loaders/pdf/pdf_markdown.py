...
Example:
    >>> from cogent.documents.loaders.pdf import PDFMarkdownLoader
    >>>
...
from cogent.observability import LogLevel, ObservabilityLogger
        ...
        *,
        ...
        if mode == "single":
            ...
            for i, doc in enumerate(documents):
                ...
                parts.append(_page_block(page_num, page_content))
